...
class MileageScoreLoader {
  ...
  load() {
    ...
    this.scope.mileageScoreChartOptions = this._options;
  ...
  private _loadChartData(chartData) {
    var labels = _.fill(Array(chartData.distances.length), '');
    this.scope.mileageScoreChartData = {
      labels,
      datasets : [
        {
...
export class Loader extends MileageScoreLoader {}