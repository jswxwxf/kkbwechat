...
class DurationScoreLoader {
  ...
  load() {
    ...
    this.scope.durationScoreChartOptions = this._options;
  ...
  private _loadChartData(chartData) {
    var labels = _.fill(Array(chartData.durations.length), '');
    this.scope.durationScoreChartData = {
      labels,
      datasets : [
        {
...
export class Loader extends DurationScoreLoader {}