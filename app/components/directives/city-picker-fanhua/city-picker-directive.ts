...
export var directiveName = 'lcbCityPickerFanhua';
...
class MultiPickerDirective implements angular.IDirective {
  ...
  template = `
    <a href="javascript:void(0)" class="lcb-city-picker-fanhua item item-icon-right">
  ...
  require = ['ngModel', 'lcbCityPickerFanhua'];
